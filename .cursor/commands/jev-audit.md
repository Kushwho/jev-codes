...
1. Run the audit in the terminal and parse stdout as JSON even on exit code 1. Use the first available:
   ...
   Forward your extra arguments as `<args>` (e.g. `--base <ref>`, `--pack <name>`). Capture stdout; stdout is the JSON report.
